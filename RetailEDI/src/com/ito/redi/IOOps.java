...
/*	public static void main(String args[]) {
	...
	static ArrayList<String> readDataFile(ArrayList<String> data, Properties pr, String fileType) throws IOException {
		try {
			String filename = "data".equals(fileType)? pr.getProperty("data.file.name"): pr.getProperty("summ.file.name");
	...
	static void writePassFile(ArrayList<String> passLine, Properties pr) throws IOException {
		try {
			FileWriter fw = new FileWriter(pr.getProperty("pass.file.name"));
